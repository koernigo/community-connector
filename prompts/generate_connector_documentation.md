...
## Output Contract
Produce a Markdown file strictly following the standard template [community_connector_doc_template.md](community_connector_doc_template.md) as `sources/{{source_name}}/README.md`.
